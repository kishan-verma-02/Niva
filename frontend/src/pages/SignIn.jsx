            ...
            <div className='w-[90%] lg:max-w-[60%] h-[600px] bg-white rounded-2xl flex justify-center items-center overflow-hidden border-2 border-[#1a1f23]'>
                <div className='w-full lg:w-[50%] h-full bg-white flex flex-col items-center justify-center p-[10px]  gap-[20px]'>
                    <div className='flex gap-[10px] items-center text-[20px] font-semibold mt-[40px]'>
                        ...
                        <div className=' relative flex items-center justify-start w-[90%] h-[50px] rounded-2xl border-2 border-black mt-[20px]' onClick={()=>setInputClicked({...inputClicked,userName: true})}>
                        ...
                        <div className=' relative flex items-center justify-start w-[90%] h-[50px] rounded-2xl border-2 border-black mt-[20px]' onClick={()=>setInputClicked({...inputClicked,password: true})}>
                        ...
                        <div className='border border-gray-500 px-17 py-1 rounded-2xl mt-[20px] cursor-pointer hover:bg-gray-200 transition duration-300 items-center justify-center' onClick={()=>navigate("/forgot-password")}>Forgot Password ?</div>

                        {err && <p className='text-red-500 font-semibold underline cursor-none'>{err}</p>}

                        <button className='w-[70%] px-[20px] py-[10px] bg-black text-white font-semibold h-[50px] cursor-pointer rounded-2xl mt-[20px]' onClick={handleSignIn} disabled={loading}>{loading?<ClipLoader size={30} color='white'/>:"Sign In"}</button>

                        <p className='text-gray-800'>Create A New Account ? <span className='border-b-2 border-b-blue pb-[3px] text-blue-900 cursor-pointer font-semibold' onClick={()=>navigate("/signup")}>Sign Up</span></p>
