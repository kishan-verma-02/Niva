...
const Messages = () => {
    ...
    return (
    <div className='w-full min-h-[100vh] flex flex-col bg-gradient-to-b from-gray-950 to-orange-950 gap-[20px] p-[10px]'>
        <div className='w-full h-[80px]  flex items-center gap-[20px] px-[20px]'>
            <TbArrowBackUpDouble className='text-white lg:hidden w-[28px] h-[28px] cursor-pointer' onClick={()=>navigate(`/`)}/>
        ...
        <div className='w-full h-full overflow-auto flex flex-col gap-[20px]'>
            {prevChatUsers.map((user,index)=>(
                <div className='text-white cursor-pointer w-full flex items-center gap-[10px]' onClick={()=>{dispatch(setSelectedUser(user))
